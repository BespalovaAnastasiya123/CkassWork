public class Mouthology {
    public static void main(String[] args) {
       ...
       Person professor = builderProfessor
                ...
                .setBiology(true)
                .setMouthology(true)
                .setEcology(true)// классе персон есть внутренний строитель:
                // говорим ему задай поля в конце верни созсозданного человека\
                .setZoology(true)
                .getPerson();
...
class Person {
    ...
    public class Builder{
        ...
        public Builder setProfession(String profession) {
            Person.this.profession = profession;//Класс Builder, this = объект Nested.Person
            return this;
        }
