...
class NifNif implements Builder{
 ...
 class NafNaf implements Builder {
    ...
    static class NufNuf implements Builder {
        @Override
        public void buildBase() {
    ...
    class Director {
        ...
        public void setBuilder(Builder builder) {//позволяет менять классы,  которые отвечают за строительство (менять директоров)
